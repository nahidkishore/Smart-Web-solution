...
const Review = () => {
  const [loggedInUser, setLoggedInUser] = useContext(UserContext);
    ...
    const handleChange = (e) => {
      const newReview = { ...reviews, name:loggedInUser.name, img:loggedInUser.photoUrl };
    ...
    const handleSubmit=(e)=> {
      e.preventDefault();
      setReviews({ ...reviews, name: loggedInUser.name, img: loggedInUser.photoURL })
  ...
  return (
    <section>
      ...
      <div className="form-group col-md-5 col-sm-12 col-12">
        ...
        <input   onChange={handleChange} type="text"  className="form-control" name="name" placeholder="Designation,Company's name "/>
        </div>
